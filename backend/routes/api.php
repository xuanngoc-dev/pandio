...
Route::middleware(['auth:sanctum', EnsureUserIsActive::class])->group(function () {
    ...
    Route::post('/hop-dong-su-dung-dich-vu/{hop_dong_su_dung_dich_vu}/ngay-dieu-phoi', [HopDongSuDungDichVuController::class, 'capNhatNgayDieuPhoi']); // Cập nhật ngày trả file / khách hẹn qua / note thợ shop
    ...
    Route::get('/tong-quan/kinh-doanh/xep-hang-sale', [DashboardController::class, 'kinhDoanhXepHangSale']); // Xếp hạng sale đầy đủ, phân trang
